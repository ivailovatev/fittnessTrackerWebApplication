...
public class ViewController {
    ...
    public String showEditPage(@RequestParam Long id, Model model) {
        ...
        return "edit-exercise"; // templates/edit-exercise.html
    }

    @PostMapping("/exercises/edit")
    public String updateExercise(@ModelAttribute ExerciseRequest request,
                                 @RequestParam Long id,
                                 RedirectAttributes redirectAttributes) {

        exerciseService.updateExercise(id, request);
        redirectAttributes.addFlashAttribute("message", "Упражнението е успешно обновено.");
        return "redirect:/exercises"; // връща към списъка
    }
